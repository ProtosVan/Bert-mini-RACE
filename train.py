...
if __name__ == "__main__":
    ...
    train_dataset = read_dataset([args.dataset_path + "/train_h/data.json", args.dataset_path + "/train_m/data.json"])
    train_dataloader = data.DataLoader(train_dataset, batch_size=batch_size)
    
    dev_dataset = read_dataset([args.dataset_path + "/dev_h/data.json"])
